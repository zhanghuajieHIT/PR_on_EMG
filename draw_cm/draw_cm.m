...
hStrings = text(x(:),y(:),textStrings(:), 'HorizontalAlignment','center', 'FontSize',30,'FontName','Times New Roman');
midValue = mean(get(gca,'CLim')); 
textColors = repmat(mat(:) > midValue,1,3); 
set(hStrings,{'Color'},num2cell(textColors,2));  %# Change the text colors

set(gca,'xticklabel',tick,'XAxisLocation','top', 'FontSize',30,'FontName','Times New Roman');
set(gca, 'XTick', 1:num_class, 'YTick', 1:num_class);
set(gca,'yticklabel',tick,'FontSize',30,'FontName','Times New Roman');
